...
# config_tsv = '231106_config_ad008.tsv'

# running stuff "from fastqs" loocally for cerberus testing
# config_tsv = '231102_config_ad003_local.tsv'

# running stuff locaclly for cerberus testing
